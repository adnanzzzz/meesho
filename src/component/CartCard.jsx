    ...
    <div class="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                        <div class="flex gap-4">
                            ...
                            <div class="flex flex-col gap-4">
                                <div>
                                    <h3 class="text-base font-bold text-gray-800">{v.name}</h3>
                                    <p class="text-sm font-semibold text-gray-500 mt-2 flex items-center gap-2">Price: {v.price}</p>
                                </div>

                                <div class="mt-auto flex items-center gap-3">
                                    <button type="button"
                                    onClick={()=>decreaseCartqty(v)} disabled={v.qty==1}
                                    ...
                                    <span class="font-bold text-sm leading-[18px]">{v.qty}</span>
                                    <button type="button" onClick={()=>increaseCartqty(v)} disabled={v.qty>5}
                                        class="flex items-center justify-center w-5 h-5 bg-gray-400 outline-none rounded-full">
                        ...
                        <div class="ml-auto flex flex-col">
                            <div class="flex items-start gap-4 justify-end">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" onClick={() => deleteCart(v.id)} class="w-4 cursor-pointer fill-gray-400 inline-block" viewBox="0 0 24 24">
                                    <path d="M19 7a1 1 0 0 0-1 1v11.191A1.92 1.92 0 0 1 15.99 21H8.01A1.92 1.92 0 0 1 6 19.191V8a1 1 0 0 0-2 0v11.191A3.918 3.918 0 0 0 8.01 23h7.98A3.918 3.918 0 0 0 20 19.191V8a1 1 0 0 0-1-1Zm1-3h-4V2a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v2H4a1 1 0 0 0 0 2h16a1 1 0 0 0 0-2ZM10 4V3h4v1Z" data-original="#000000"></path>
                                    <path d="M11 17v-7a1 1 0 0 0-2 0v7a1 1 0 0 0 2 0Zm4 0v-7a1 1 0 0 0-2 0v7a1 1 0 0 0 2 0Z" data-original="#000000"></path>
                                </svg>
                            </div>
                            <h3 class="text-base font-bold text-gray-800 mt-auto">{v.price * v.qty}</h3>
                        </div>
                    </div>
  )
}
